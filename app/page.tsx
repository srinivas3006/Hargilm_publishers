              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-2">
                ...
                <Link href="/books">
                  <Button
                    size="lg"
                    variant="outline"
                    className="w-full sm:w-auto border-2 border-white/30 text-white hover:bg-white/10 hover:border-white/60 h-14 px-8 rounded-full text-base font-bold transition-all"
                  >
